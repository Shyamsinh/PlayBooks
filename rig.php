...
<form id="regForm" method="POST" action="action1.php">
  <h1>Register:</h1>
  ...
  <div class="tab">Contact Info:
    ...
    <p><input type="number" class="no-spin" min="1111111111" max="9999999999" placeholder="Phone..." oninput="this.className = ''" name="phone"></p>
	<p>
	        <b>City:</b>&nbsp;&nbsp;</td>
  ...
  <div class="tab"><h2>Gender:</h2>
    <p>Male:<input type="radio" name="Gender" value="Male" required></p>
  ...
  <div class="tab">Login Info:
    ...
    <p><input type="password" placeholder="Password..." oninput="this.className = ''" name="pword" ></p>
  </div>
